...
print("Instalando yt-dlp e requirements no Debian...")
stdin, stdout, stderr = ssh.exec_command('proot-distro login debian -- /root/luci-server/venv/bin/pip install yt-dlp')
...
# Testar se o backend local respondeu
